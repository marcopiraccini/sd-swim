...
exports.compareMemberLists = (expected, actual) => deepEqual(sortBy(expected, [compareMember]), sortBy(actual, [compareMember]))
exports.compareNodesLists = (expected, actual) => deepEqual(sortBy(expected, [compareNode]), sortBy(actual, [compareNode]))
